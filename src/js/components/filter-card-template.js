...
export function createFiltersCardsSkeleton(amount) {
  ...
  for (let i = 0; i < amount; i++) {
    skeleton +=
      '<li class="exercises__skeleton-loader"><span class="skeleton-loader"><svg class="exercises__image-skeleton" width="30" height="30"><use href="./img/icons.svg#img"></use></svg><span></span></span></li > ';
  }
  return skeleton;
}
